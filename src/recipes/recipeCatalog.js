/** @typedef {{ id: string, title: string, prepTime: string, ingredients: string[], instructions: string[], cuisine?: string, mainIngredient?: string, source?: string, sourceUrl?: string, imageUrl?: string, category?: string }} Recipe */
