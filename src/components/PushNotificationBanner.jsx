...
export function PushNotificationBanner({ title, body, onDismiss }) {
  return (
    ...
    >
      <div className="pointer-events-auto flex w-full max-w-lg gap-3 rounded-2xl border border-emerald-200/80 bg-lm-raised/95 p-3 shadow-lm-card backdrop-blur-md dark:border-emerald-800/60 dark:bg-dm-raised/95">
