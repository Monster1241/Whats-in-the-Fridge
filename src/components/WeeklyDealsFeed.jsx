...
const SECTIONS = [
  {
    ...
    accent: {
      ...
      indicator: 'bg-white shadow-md ring-1 ring-rose-200/80 dark:bg-dm-card dark:ring-rose-900',
    },
  },
  {
    id: 'catalogues',
    ...
    accent: {
      ...
      indicator: 'bg-white shadow-md ring-1 ring-sky-200/80 dark:bg-dm-card dark:ring-sky-900',
    },
  },
];
...
const STORE_FILTERS = [
  {
    ...
    idle:
      'bg-white text-slate-700 ring-slate-200 hover:bg-slate-50 dark:bg-dm-card dark:text-slate-200 dark:ring-slate-600',
  },
  {
    id: 'coles',
    label: 'Coles',
...
function PostcodeModal({ postcode, draft, onDraftChange, onSave, onClose, error }) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-xs rounded-2xl border border-slate-200 bg-white p-4 shadow-2xl dark:border-slate-700 dark:bg-dm-card"
      ...
      >
        ...
        <label className="block">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-center text-lg font-bold tracking-[0.2em] text-slate-900 outline-none ring-sky-300/0 focus:border-sky-400 focus:ring-2 focus:ring-sky-300/40 dark:border-slate-600 dark:bg-dm-card dark:text-slate-100"
          />
        </label>
...
function PostcodeChip({ postcode, regionLabel, onClick }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="inline-flex shrink-0 items-center gap-1 rounded-full bg-white/90 px-2.5 py-1.5 text-xs font-bold text-slate-700 ring-1 ring-slate-200/90 transition hover:bg-white hover:ring-sky-300 active:scale-[0.98] dark:bg-dm-inset dark:text-slate-200 dark:ring-slate-600 dark:hover:ring-sky-700"
...
function SectionToggle({ activeSection, onChange, dealsCount, cataloguesCount }) {
  ...
  return (
    <div
      className="rounded-2xl bg-slate-100/90 p-1 ring-1 ring-slate-200/80 dark:bg-dm-inset dark:ring-white/10"
      role="tablist"
...
function WeeklyDealCard({ deal, showAddedFeedback, onAdd }) {
  ...
  return (
    <article className="relative flex min-h-[10.5rem] flex-col overflow-hidden rounded-2xl border border-amber-200/60 bg-white shadow-sm dark:border-amber-900/40 dark:bg-dm-card">
...
function CatalogueCard({ catalogue }) {
  ...
  return (
    <article
      className={`overflow-hidden rounded-2xl border border-slate-200/90 border-l-4 bg-white shadow-sm transition hover:shadow-md dark:border-slate-700 dark:bg-dm-card ${accent}`}
    >
      <div className="flex gap-3 p-3.5 sm:gap-4 sm:p-4">
        <div className="flex w-[4.5rem] shrink-0 flex-col gap-2 sm:w-20">
          <div className="flex h-11 items-center justify-center rounded-xl bg-slate-50 p-1.5 ring-1 ring-slate-200/80 dark:bg-dm-card dark:ring-slate-700">
      ...
      <div className="grid grid-cols-2 gap-2 border-t border-slate-100 bg-slate-50/50 p-3 dark:border-slate-800 dark:bg-dm-inset">
        <button
          type="button"
