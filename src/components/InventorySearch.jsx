              ...
              {results.map((item) => {
                ...
                return (
                  <li
                    ...
                    className="rounded-xl border border-slate-200 bg-slate-50/80 p-3 dark:border-slate-600 dark:bg-black/50"
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() => onEdit(item)}
                        className="inline-flex items-center justify-center gap-1 rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-bold text-slate-700 active:scale-[0.98] dark:border-slate-600 dark:bg-black dark:text-slate-200"
                      >
