...
const KEYWORD_RULES = [
  ...
  },
  {
    ...
    store: 'Coles / Woolworths / Fish markets',
    detail:
      'Everyday fillets and frozen packs: Coles, Woolworths, or ALDI (Ocean Royale frozen line). For the best fresh catch, try Harris Farm Markets or your local fishmonger.',
  },
  {
    keywords: ['chicken', 'beef', 'pork', 'chorizo', 'bacon', 'mince', 'thigh', 'breast'],
    store: 'ALDI',
    detail:
