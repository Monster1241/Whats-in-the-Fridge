...
const SUBCATEGORY_RULES = [
  ...
  // Ambient
  // Ambient — dried herbs & spices (before pantry staples for powder/seasoning matches)
  {
    itemType: ITEM_TYPE.FOOD,
  ...
  },
  {
    ...
    keywords: ['frozen chicken', 'frozen fish', 'frozen prawn', 'frozen meat', 'frozen salmon', 'frozen barramundi', 'frozen calamari', 'frozen squid', 'frozen seafood', 'frozen scallop', 'frozen mussel', 'fish fingers', 'crumbed fish'],
  },
  {
    itemType: ITEM_TYPE.FOOD,
    category: FOOD_CATEGORY.FREEZER,
