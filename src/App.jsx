  ...
  return (
    ...
    >
      <div className="surface-card w-full max-w-md p-5 shadow-2xl">
        ...
        <div
          className={`mb-3 grid gap-1 rounded-xl border border-slate-200 bg-slate-100 p-1 dark:border-white/10 dark:bg-dm-inset ${getModuleGridClass(getEnabledModuleList(enabledModules).length)}`}
        >
        ...
        <label className="surface-inset mb-3 flex cursor-pointer items-center gap-2 px-3 py-3 text-sm text-slate-700 dark:text-slate-300">
          <input
            ...
            className="h-4 w-4 rounded border-slate-300 bg-white text-sky-600 focus:ring-sky-500 dark:border-white/20 dark:bg-dm-raised"
          />
          ...
          <>
            <label className="mb-3 flex cursor-pointer items-center gap-2 text-sm text-slate-700 dark:text-slate-300">
              <input
                ...
                className="h-4 w-4 rounded border-slate-300 bg-white text-emerald-600 focus:ring-emerald-500 dark:border-white/20 dark:bg-dm-raised"
              />
              Set expiry date
            </label>
            {hasExpiry && (
            ...
            <button
              ...
              className={`scope-tab-btn rounded-xl border px-2 py-2.5 text-center text-sm font-bold active:scale-[0.98] ${
                active
                  ...
                  : 'border-slate-200 bg-white text-slate-600 hover:border-slate-300 dark:border-white/10 dark:bg-dm-raised dark:text-zinc-400'
              }`}
            >
            ...
            <button
              ...
              className={`storage-tab-btn rounded-xl border px-2 py-3 text-center active:scale-[0.98] ${
                active
                  ...
                  : `border-slate-200 bg-white dark:border-white/10 dark:bg-dm-raised ${meta.tabIdle}`
              }`}
            >
              ...
              {showAddAdvanced && (
                <>
                  ...
                  <div>
                    ...
                    <div
                      className={`grid gap-1 rounded-xl border border-slate-200 bg-slate-100 p-1 dark:border-white/10 dark:bg-dm-inset ${getModuleGridClass(getEnabledModuleList(enabledModules).length)}`}
                    >
                      {getEnabledModuleList(enabledModules).map((mod) => (
                        <button
                          key={mod.key}
          ...
          <button
            ...
            className={`flex h-10 w-10 items-center justify-center rounded-xl border transition active:scale-95 ${
              isSaved
                ...
                : 'border-slate-200 bg-slate-50 text-slate-500 hover:border-violet-300 hover:text-violet-600 dark:border-white/10 dark:bg-dm-raised dark:hover:text-violet-400'
            }`}
            ...
            <div className="rounded-xl border border-sky-200 bg-sky-50 p-3 dark:border-sky-800 dark:bg-sky-950/40">
              ...
              <div className="mt-3 flex gap-2">
                <button
                  ...
                  className="flex-1 rounded-lg border border-slate-200 bg-white py-2.5 text-xs font-semibold text-slate-700 dark:border-white/10 dark:bg-dm-raised dark:text-zinc-200"
                >
                  Cancel
                </button>
                <button
    ...
    <section className="surface-card mb-5 overflow-hidden p-4">
      ...
      {open && (
        <div className="mt-4 space-y-4 border-t border-slate-200 pt-4 dark:border-slate-600">
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-50/80 p-3 dark:border-slate-600 dark:bg-dm-inset">
                ...
                return (
                  ...
                  >
                    <input
                      ...
                      className="mt-1 h-4 w-4 rounded border-slate-300 text-emerald-600 focus:ring-emerald-500 dark:border-white/20 dark:bg-dm-raised"
                    />
                    <div className="min-w-0 flex-1">
        ...
        {membersLoading ? (
          ...
          <ul className="mb-4 space-y-2">
            {members.map((member) => (
              <li
                key={member.id}
                className="flex items-center justify-between gap-3 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 dark:border-slate-600 dark:bg-dm-inset"
              >
                <div className="min-w-0 flex-1">
          ...
          <div className="mb-4 rounded-xl border border-violet-200 bg-violet-50/80 p-3 dark:border-violet-800 dark:bg-violet-950/30">
            ...
            <div className="flex flex-col gap-2">
              <button
                ...
                className="flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white py-2.5 text-sm font-semibold text-slate-800 active:scale-[0.98] dark:border-white/10 dark:bg-dm-raised dark:text-zinc-200"
              >
